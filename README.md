...
| `CONVERT_CONCURRENCY` | `2` | How many conversions run in parallel (each ffmpeg is ~single-threaded) |
...
| `COVER_SIZE` | `500` | Max edge (px) for downloaded cover art; Amazon CDN images are requested at this size |
